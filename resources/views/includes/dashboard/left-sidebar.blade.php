                    ...
                    <!-- general affair -->
                        @if(Auth::user()->company_id == 1 && Auth::user()->department_id == 4 || Auth::user()->role == 1)
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('admin-covid-test.index') }}"> Test Covid </a></li>
                                    <li><a href="{{ route('admin-covid-slider.index') }}"> Slider </a></li>
                                </ul>
                            </li>
                        @endif
                    <!-- general affair -->
                    ...
                    @if(Auth::user()->company_id == 1 && Auth::user()->department_id == 4)
                        @if(Auth::user()->user_level == 7)
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('user-covid-test.index') }}"> Test Covid </a></li>
                                    <li><a href="{{ route('user-covid-slider.index') }}"> Slider </a></li>
                                </ul>
                            </li>
                        @endif 
                    @endif
