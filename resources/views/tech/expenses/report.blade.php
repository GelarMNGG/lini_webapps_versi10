                        ...
                        <div class="d-print-none">
                            <div class="float-right">
                                ...
                                @if($dataReportCount < 1)
                                    <form action="{{ route($formRouteReport, 'project_id='.$projectTaskInfo->project_id.'&task_id='.$projectTaskInfo->id) }}" style="display:inline-block" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                        @csrf
                                        @method('PUT')

                                        <!-- hidden data -->
                                        @foreach($dataReportExpenses as $dataHidden)
                                            <input type="text" name="expense_id[]" value="{{ $dataHidden->id }}" hidden>
                                        @endforeach
