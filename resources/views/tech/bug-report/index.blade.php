...
<?php ### customized data
    ...
    $formRouteCreate = 'tech-bug-report.create';
    $formRouteStore = 'tech-bug-report.store';
    $formRouteEdit = 'tech-bug-report.edit';
    $formRouteDestroy = 'tech-bug-report.destroy';
?>
@endsection
                        ...
                        <div class="col-6 p-2 small">
                            ...
                            <div class="img-ca-box">
                                    @if(isset($data->image) && $data->image != 'default.png')
                                                ...
                                                <div class="modal-dialog modal-dialog-centered justify-content-center" role="document">
                                                    <div class="modal-content-img">
                                                        ...
                                                        <button type="button" class="close close-img" data-dismiss="modal" aria-label="Close">
                                                            <img name="image" class="img-fluid" style="margin-bottom:-2px;" src="{{ asset('/img/bug-report/tech/'.$data->image) }}"  />
                                        ...
                                        <img class="img-ca" src="{{ asset('img/bug-report/tech/'.$data->image) }}">
                                    @else
