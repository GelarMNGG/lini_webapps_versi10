                        ...
                        <div class="panel-body">
                            ...
                            <div class="d-print-none">
                                <div class="float-right">
                                    ...
                                    <form action="{{ route($formRouteReport, 'task_id='.$projectTask->id) }}" style="display:inline-block" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                        @csrf
                                        @method('PUT')

                                        <!-- hidden data -->
                                        @foreach($dataReportTools as $dataHidden)
                                            <input type="text" name="tool_id[]" value="{{ $dataHidden->id }}" hidden>
                                        @endforeach
