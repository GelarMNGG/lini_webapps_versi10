...
<?php ### customized data
    ...
    $formRouteIndex = 'payment-summary-tech.index';
    $formRouteStore = 'payment-summary-tech.store';
?>
@endsection
        ...
        <form class="w-100" action="{{ route($formRouteStore) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row m-0">
                ...
                <div class="form-group mt-3">
                        <label for=""></label>
                        <button type="submit" class="btn btn-info t-white" name="submit">Upload</button>
