...
<?php ### customized data
    ...
    $formRouteIndex = 'teamusertitle.index';
    $formRouteCreate = 'teamusertitle.create';
    $formRouteStore = 'teamusertitle.store';
    $formRouteEdit = 'teamusertitle.edit';
    $formRouteDestroy = 'teamusertitle.destroy';

    //admin minutes
    $formTeamUserIndex = 'teamuser.index';
?>
@endsection
...
<div class="flash-message mt-2">
    ...
    @if (count($userLevels) > 0)
        <div class="card mt-2">
            ...
            <div class="card-body">
                <div class="col-md">
                    <a href="{{ route($formRouteCreate) }}" class="btn btn-orange mt-1"><i class="fa fa-plus"></i> Tambah jabatan</a>
                    <a href="{{ route($formTeamUserIndex) }}" class="btn btn-orange mt-1"><i class="fa fa-eye"></i> Lihat semua user</a>
                </div>
            </div>
        </div> <!-- card -->
    @else
