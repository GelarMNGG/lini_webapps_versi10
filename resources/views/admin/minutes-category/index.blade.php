...
<?php ### customized data
    ...
    $formRouteCreate = 'admin-minutes-category.create';
    $formRouteStore = 'admin-minutes-category.store';
    $formRouteEdit = 'admin-minutes-category.edit';
    $formRouteDestroy = 'admin-minutes-category.destroy';

    //admin minutes
    $formMinutesIndex = 'admin-minutes.index';
?>
@endsection
