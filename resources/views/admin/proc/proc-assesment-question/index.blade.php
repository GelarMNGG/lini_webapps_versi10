...
<?php ### customized data
    ...
    $formRouteCreate = 'admin-proc-assesment-question.create';
    $formRouteStore = 'admin-proc-assesment-question.store';
    $formRouteEdit = 'admin-proc-assesment-question.edit';
    $formRouteDestroy = 'admin-proc-assesment-question.destroy';

    //add category
    $formCategoryIndex = 'admin-assesment-question-cat.index';

    //add Answer
    $formAnswerCreate = 'admin-proc-assesment-answer.create';
    $formAnswerEdit = 'admin-proc-assesment-answer.edit';
