...
<?php ### customized data
    ...
    $formRouteIndex = 'admin-assesment-question-cat.index';
    $formRouteCreate = 'admin-assesment-question-cat.create';
    $formRouteStore = 'admin-assesment-question-cat.store';
    $formRouteEdit = 'admin-assesment-question-cat.edit';
    $formRouteDestroy = 'admin-assesment-question-cat.destroy';

    //admin minutes
    $formCategoryIndex = 'admin-proc-assesment-question.index';
?>
@endsection
        ...
        <div class="card mt-2">
            ...
            <div class="card-body">
                <div class="col-md">
                    ...
                    <a href="{{ route($formCategoryIndex) }}" type="button" class="btn btn-blue-lini mt-1">Kembali</a>
                </div>
            </div>
        </div> <!-- card -->
    @else
