...
<?php ### customized data
    ...
    $formRouteIndex = 'admin-proc-question-category.index';
    $formRouteCreate = 'admin-proc-question-category.create';
    $formRouteStore = 'admin-proc-question-category.store';
    $formRouteEdit = 'admin-proc-question-category.edit';
    $formRouteDestroy = 'admin-proc-question-category.destroy';

    //admin minutes
    $formCategoryIndex = 'admin-proc-question.index';
?>
@endsection
