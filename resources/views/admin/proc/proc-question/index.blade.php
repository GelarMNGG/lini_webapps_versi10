...
<?php ### customized data
    ...
    $formRouteCreate = 'admin-proc-question.create';
    $formRouteStore = 'admin-proc-question.store';
    $formRouteEdit = 'admin-proc-question.edit';
    $formRouteDestroy = 'admin-proc-question.destroy';
