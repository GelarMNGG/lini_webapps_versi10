...
<?php ### customized data
    ...
    $formRouteUpdate = 'admin-proc-assesment-answer.update';
?>
@endsection
            ...
            <div class="row m-0">
                <div class="col-md">
                    ...
                    <div class="form-group{{ $errors->has('answer_c') ? ' has-error' : '' }}">
                        <label>Pilihan Jawaban C <small class="c-red">*</small></label>
                        <textarea name="answer_c" class="form-control" cols="10" rows="2" required>{{ old('answer_c') ? old('answer_c') : $dataAnswer->answer_c }}</textarea>
                    </div>
                    <div class="form-group{{ $errors->has('answer_d') ? ' has-error' : '' }}">
                        <label>Pilihan Jawaban D <small class="c-red">*</small></label>
                        <textarea name="answer_d" class="form-control" cols="10" rows="2" required>{{ old('answer_d') ? old('answer_d') : $dataAnswer->answer_d }}</textarea>
                    </div>
                </div>
            </div>
        </div>
