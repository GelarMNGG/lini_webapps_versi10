...
@section ('data')
<?php ### customized data
    $pageTitle      = 'Tambah jawaban';
    $formRouteIndex = 'admin-proc-assesment-question.index';
    $formRouteStore = 'admin-proc-assesment-answer.store';
?>
@endsection
            ...
            <div class="row m-0">
                <div class="col-md">
                    ...
                    <div class="form-group{{ $errors->has('answer_b') ? ' has-error' : '' }}">
                        ...
                        <textarea name="answer_c" class="form-control" cols="10" rows="2" required>{{ old('answer_c') }}</textarea>
                    </div>
                    <div class="form-group{{ $errors->has('answer_b') ? ' has-error' : '' }}">
                        <label>Pilihan Jawaban D <small class="c-red">*</small></label>
                        <textarea name="answer_d" class="form-control" cols="10" rows="2" required>{{ old('answer_d') }}</textarea>
                    </div>
                </div>
            </div>
            <div class="card-body">
