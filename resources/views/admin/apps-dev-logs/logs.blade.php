...
<div class="card mt-2">
    ...
    <div class="card-header text-center bb-orange">
        <div class="text-uppercase">
            ...
            <!-- all department -->
                <br>
                <select name="pid" class="form-control select2 text-uppercase" style="display:inline-block; text-align-last:center" onchange="location = this.value;">
                    @if (isset($requestProgrammer) || isset($requestDepartment) || isset($requestStatus))
                        @if(isset($requestDepartment))
                            @if(isset($requestStatus))
                                @if(isset($requestProgrammer))
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel{{ $dataLog->status == 0 ? ' bg-gray-op15' : '' }}">
                                            <div class="panel-body">
                                                ...
                                                <span class="timeline-icon bg-{{ $statusBadge[$ib] }}">
                                                    <i class="mdi mdi-circle">
                                                        <span class="text-danger small" style="display:inline-block">{{ $i }}</span>
                                                    </i>
                                                </span>
