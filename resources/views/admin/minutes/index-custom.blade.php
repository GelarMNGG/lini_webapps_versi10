...
<div class="flash-message mt-2">
    ...
    @if (count($adminMinutes) > 0)
        <div class="card mt-2">
            <div class="card-header text-center text-uppercase bb-orange">
                <div class='badge badge-info float-left'>{{ $adminMinutes->total() }}</div>
                @if($date != NULL)
            ...
            <div class="bg-gray-lini-2">
                <div class="card-body">
                    <div class="row m-0">
                        ...
                        <div class="col-md">
                            <?php 
                                #$adminMinutes->setPath('minutes-tech?project_id='.$projectTask->project_id.'&task_id='.$projectTask->id);
                            ?>
                            {{ $adminMinutes->links() }}
                        </div>
                    </div>
