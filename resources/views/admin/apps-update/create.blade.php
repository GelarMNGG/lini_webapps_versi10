...
@section ('data')
<?php ### customized data
    $pageTitle      = 'Buat update'; 
    $formRouteIndex = 'apps-update.index';
    $formRouteStore = 'apps-update.store';
?>
@endsection
            ...
            <div class="row m-0">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control{{ $errors->has('title') ? ' has-error' : '' }}" value="{{ old('title') ?? '' }}" placeholder="Judul update" required>
                    </div>
                </div>
