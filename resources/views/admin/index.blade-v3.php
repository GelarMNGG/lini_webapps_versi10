...
<?php ### customized data
    ...
    $formTroubleshootingShow = 'admin.troubleshootingdetail';
    $allMembersPage = 'admin.allmembersdepartment';
?>
@endsection
...
<div class="row">
    <div class="col-xl-12">
        <div class="card-box">
            <h4 class="header-title mt-0 mb-3">Grafik aktifitas harian <small class="text-muted">(done vs inprogress)</small></h4>

            <div id="smil-animations" class="ct-chart ct-golden-section"></div>
            <small>Ket: <span class="text-purple">-- done</span>, <span class="text-pink">-- inprogress</span>. </small>
...
<div class="card">
    <div class="card-header bb-orange"><span class="badge badge-pink float-left mr-1">{{ sizeof($prDatas) <= 5 ? sizeof($prDatas) : '>5' }}</span> PR terbaru</div>
    <div class="card-body">
        @if(sizeof($prDatas) > 0)
