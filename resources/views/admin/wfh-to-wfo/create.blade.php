...
@section ('data')
<?php ### customized data
    $pageTitle      = 'Pengajuan WFH to WFO';
    $formRouteIndex = 'admin-wfh-to-wfo.index';
    $formRouteStore = 'admin-wfh-to-wfo.store';
?>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-md form-group">
                                ...
                                <div class="input-group">
                                    <input id="timepicker3" name="clock_in" type="text" class="form-control" value="{{ old('clock_in') ?? '' }}" required>
                            ...
                            <div class="col-md form-group">
                                ...
                                <div class="input-group">
                                    <input id="timepicker" name="clock_out" type="text" class="form-control" value="{{ old('clock_out') ?? '' }}" required>
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="mdi mdi-clock-outline"></i></span>
                                    </div>
                                </div><!-- input-group -->
