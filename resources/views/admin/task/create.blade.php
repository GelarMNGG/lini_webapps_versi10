        ...
        <div class="card-body bg-gray-lini-2">
            ...
            <div class="row m-0">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="task_title" class="form-control{{ $errors->has('task_title') ? ' has-error' : '' }}" value="{{ old('task_title') ?? '' }}" placeholder="Judul tugas" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md form-group">
                            ...
                            <input type="date" class="form-control{{ $errors->has('task_date') ? ' has-error' : '' }}" name="task_date" value="{{ old('task_date') ?? '' }}" min="{{ date('Y-m-d') }}" placeholder="dd/mm/yyyy">
                        ...
                        <div class="col-md form-group">
                            ...
                            <input type="date" class="form-control{{ $errors->has('task_due_date') ? ' has-error' : '' }}" name="task_due_date" value="{{ old('tp_date_end') ?? '' }}" min="{{ date('Y-m-d') }}" placeholder="dd/mm/yyyy">
            ...
            <div class="row m-0" style="display:inline">
                <div class="col-md">
                    ...
                    <textarea name="task_desc" class="form-control" cols="10" rows="5" required>{{ old('task_desc') }}</textarea>
                </div>
            </div>
            <div class="w-100 mt-2"></div>
            <div class="col-md alert alert-warning">
                <label for="">Bobot </label>
                <input type="number" name="grade" class="form-control{{ $errors->has('grade') ? ' has-error' : '' }}" value="{{ old('grade') }}" placeholder="Bobot">
            </div>
        </div>
        <div class="card-body">
            <div class="col-md">
