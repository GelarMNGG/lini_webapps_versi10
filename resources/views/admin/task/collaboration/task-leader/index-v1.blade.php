...
@section ('data')
<?php ### customized data
    $pageTitle      = 'Leaders Collaboration Tasks';
    ...
    //route
    $formRouteCreate = 'task-leaders.create';
    $formRouteEdit = 'task-leaders.edit';
    $formRouteShow = 'task-leaders.show';
    
    //intern dept collaboration task
    $formInternalCollaborationIndex = 'task-internal.index';
...
<div class="flash-message mt-2">
    ...
    @if ($countData > 0)
        ...
        <div class="card mt-2">
            ...
            <div class="card-body">
                <div class="col-md">
                    <a href="{{ route($formRouteCreate) }}" class="btn btn-orange"><i class="fa fa-plus"></i> Kolaborasi multi departemen</a>
                    <a href="{{ route($formInternalCollaborationIndex) }}" class="btn btn-orange"><i class="fa fa-eye"></i> Kolaborasi internal</a>
