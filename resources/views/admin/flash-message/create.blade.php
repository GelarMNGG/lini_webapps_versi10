...
<?php ### customized data
    ...
    $formRouteStore = 'flash-messages.store';
?>
@endsection
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="level" name="level" class="form-control select2{{ $errors->has('level') ? ' has-error' : '' }}" required>
                                ...
                                @endif
                                    ...
                                    <option value="warning">Sedang</option>
            ...
            <div class="row m-0">
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" name="message" class="form-control{{ $errors->has('message') ? ' has-error' : '' }}" value="{{ old('message') ?? '' }}" placeholder="Pesan" required>
                    </div>
                </div>
                <div class="col-md">
                    <div class="form-group">
                        <label>View <small class="c-red">*</small></label>
                        <input type="number" name="views" class="form-control{{ $errors->has('views') ? ' has-error' : '' }}" min="0" value="{{ old('views') ?? '' }}" required>
                    </div>
                </div>
            </div>
        </div>
