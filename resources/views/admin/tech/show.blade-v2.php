...
<?php ### customized data
    ...
    $formRouteCreate = 'admin-tech.create';
    $formRouteEdit = 'admin-tech.edit';
    $formRouteShow = 'admin-tech.show';
    $formRouteDestroy = 'admin-tech.destroy';
                                                            ...
                                                            <div class="row bg-gray-lini-2">
                                                                ...
                                                                <div class="col-md">
                                                                    <div class="form-group">
                                                                        <label for=""></label>
                                                                        <input type="submit" class="btn btn-orange" name="submit" value="Beri nilai">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md">
                                                                    <div class="alert alert-warning">
                                                                        Tipe kepribadian yang sesuai dengan pekerjaan teknisi adalah kepribadian <span><strong>INTJ</strong></span>.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
                                        ...
                                        <div class="row alert alert-warning m-0 small mb-1">
                                            ...
                                            @if(isset($testAssessmentResult))
                                                @foreach($testAssessmentResult as $testAssessmentResult)
                                                    <div class="col-md mt-1">
                                                        <strong>Tanggal tes</strong>
                                                        <br>{{ isset($testAssessmentResult->created_at) ? date('l, d F Y',strtotime($testAssessmentResult->created_at)) : '-' }}
                                                    </div>
                                                    <div class="col-md mt-1">
                                                        <strong>Hasil</strong>
                                                        <br>
                                                        ...
                                                        <form action="{{ route($formTechRatingStore) }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row bg-gray-lini-2">
                                                                ...
                                                                <div class="col-md">
                                                                    <div class="form-group">
                                                                        <label for=""></label>
                                                                        <input type="submit" class="btn btn-orange" name="submit" value="Rate">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
