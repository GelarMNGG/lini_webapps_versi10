...
<?php ### customized data
    ...
    $formRouteIndex = 'user-minutes-report.index';
    $formRouteEdit = 'user-minutes-report.edit';

    $formRouteCreate = 'user-minutes-report.create';
    //add category
    $formCategoryIndex = 'user-minutes-category.index';
?>
@endsection
...
<div class="flash-message mt-2">
    ...
    @if (count($userMinutes) > 0)
        <div class="card mt-2">
                    ...
                    @foreach ($userMinutes as $data)
                        <div class="col-sm p-2">
                            <div class="bg-card-box br-5 p-2">
                                ...
                                <span class="text-info">@if(isset($data->date)) {{ date('l, d F Y', strtotime($data->date))}} @endif</span>
            ...
            <div class="card-body">
                <div class="col-md"> 
                    <a href="{{ route($formRouteCreate,'skin='.$skinBack) }}" class="btn btn-orange"><i class="fa fa-plus"></i> Create daily report</a>
