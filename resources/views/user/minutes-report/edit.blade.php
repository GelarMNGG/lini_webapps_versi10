...
@section ('data')
<?php ### customized data
    $pageTitle      = 'Edit aktivitas harian';
...
<div class="card mt-2">
    <div class="card-header text-center text-uppercase bb-orange">
        ...
        | <span class="text-danger">{{ ucwords($userMinute->firstname).' '.ucwords($userMinute->lastname) }}</span>
    </div>
        ...
        <div class="card-body bg-gray-lini-2">
            <div class="row m-0">
                ...
                <div class="col-md alert alert-warning">
                    ...
                    <input type="number" name="grade" class="form-control{{ $errors->has('grade') ? ' has-error' : '' }}" value="{{ old('grade') ? old('grade') : $userMinute->grade }}" placeholder="Bobot">
                </div>
            </div>     
        </div>
        <div class="card-body">
