...
<?php ### customized data
    ...
    $formRouteUpdate= 'user-minutes-report.update';
    //custom report
    if (Auth::user()->company_id == 1) {
        $formRouteCustomReport = 'user-minutes-report.customreport';
    }else{
        $formRouteCustomReport = 'user-minutes-report.customreportlintaslog';
    }
?>
@endsection
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($tasksDatas as $data1)
                                                        <tr>
                                                            ...
                                                            <td><span class="text-danger"><small>{{ isset($data1->task_due_date) ? date('l, d F Y', strtotime($data1->task_due_date)) : '-'}}</small></span></td>
                                                        </tr>
                                                        <?php $i++; ?>
                                                    @endforeach
                                                </tbody>
