...
<?php ### customized data
    ...
    $formRouteCreate = 'user-proc-competency-test.create';
    $formRouteStore = 'user-proc-competency-test.store';
    $formRouteEdit = 'user-proc-competency-test.edit';
    $formRouteDestroy = 'user-proc-competency-test.destroy';
