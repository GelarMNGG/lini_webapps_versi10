...
<?php ### customized data
    ...
    $formRouteIndex = 'user-assesment-question-cat.index';
    $formRouteCreate = 'user-assesment-question-cat.create';
    $formRouteStore = 'user-assesment-question-cat.store';
    $formRouteEdit = 'user-assesment-question-cat.edit';
    $formRouteDestroy = 'user-assesment-question-cat.destroy';

    //user minutes
    $formCategoryIndex = 'user-proc-assesment-question.index';
?>
@endsection
