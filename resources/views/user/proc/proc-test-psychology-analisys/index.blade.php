...
<?php ### customized data
    ...
    $formRouteCreate = 'user-test-psychology-analisys.create';
    $formRouteStore = 'user-test-psychology-analisys.store';
    $formRouteEdit = 'user-test-psychology-analisys.edit';
    $formRouteDestroy = 'user-test-psychology-analisys.destroy';

    //admin minutes
    $formPsychologyIndex = 'user-proc-test-psychology.index';
?>
@endsection
