...
<?php ### customized data
    ...
    $formRouteShow = 'user-task-internal.show';

    //todo
    $formRouteEdit = 'user-task-internal-todo.edit';
    $formRouteUpdate = 'user-task-internal-todo.update';

    //todo file
    $formFileStore = 'user-task-internal-todo-file.store';

    //todo comments
    $formCommentsStore = 'user-task-internal-todo-comment.store';
?>
@endsection
                            ...
                            <div class="media mb-3">
                                <div class="media-body">
                                    @if(isset($internalTodoFiles))
                                        <?php $i = 1; ?>
                                        <div class="row mb-1">
                                            @foreach($internalTodoFiles as $internalFile)
                                    ...
                                    @if(Auth::user()->id == $todoData->receiver_id || (Auth::user()->id == $taskData->publisher_id && Auth::user()->user_type == $taskData->publisher_type))
                                        <div>
