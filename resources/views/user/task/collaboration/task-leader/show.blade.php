                                                    ...
                                                    @foreach($leadersTodos as $todo)
                                                        @if($todo->department_id == $userReceiver->department_id)
                                                            <div class="col-md-12 mb-1">
                                                                ...
                                                                @if(Auth::user()->id == $todo->requester_id && Auth::user()->department_id == $todo->requester_department && Auth::user()->user_type == $todo->requester_type || (Auth::user()->id == $taskData->publisher_id && Auth::user()->user_type == $taskData->publisher_type))
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md{{ $errors->has('image') ? ' has-error' : '' }}">
                                                            <div class="card-box">
                                                                ...
                                                                <input type="file" name="image" class="dropify" data-max-file-size="1M" data-default-file="{{ asset('img/comment-file/task-leaders/default.png') }}" required />
                                                            </div>
                                                        </div>
                                                        <div class="w-100"></div>
                                                        <div class="col-md mt-2 mb-2">
