...
<?php ### customized data
    ...
    //todo
    $formRouteEdit = 'user-task-leaders-todo.edit';
    $formRouteUpdate = 'user-task-leaders-todo.update';

    //todo file
    $formFileStore = 'user-task-leaders-todo-file.store';

    //todo comments
    $formCommentsStore = 'user-task-leaders-todo-comment.store';
?>
@endsection
                ...
                <div class="row">
                    <div class="col-md">
                        <div class="card-box task-detail">
                            ...
                            <hr>
                            <?php $coAdminDatas[] = $coAdminDatas; ?>
                            @if(in_array(Auth::user()->id,$coAdminDatas) || Auth::user()->department_id == $todoData->department_id)
                                <div class="row m-0">
                                    <h4 class="text-secondary">Upload supporting documents</h4>
                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md{{ $errors->has('image') ? ' has-error' : '' }}">
                                                                    <div class="card-box">
                                                                        ...
                                                                        <input type="file" name="image" class="dropify" data-max-file-size="1M" data-default-file="{{ asset('img/upload-doc/task-leaders/default.png') }}" required />
                                                                    </div>
                                                                </div>
                                                                <div class="w-100"></div>
