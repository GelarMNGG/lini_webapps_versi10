...
<?php ### customized data
    ...
    //collaboration
    $formRouteBack = 'user-collaboration.index';
?>
@endsection
...
@section('content')
    ...
    @if ($countData > 0)
        <div class="card mt-2">
            ...
            <div class="card-body">
                <div class="col-md">
                    <a href="{{ route($formInternalDeptCollaborationIndex) }}" class="btn btn-orange"><i class="fa fa-eye"></i> Kolaborasi internal departemen</a>
