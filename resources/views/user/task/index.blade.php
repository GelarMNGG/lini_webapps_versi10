...
<?php ### customized data
    ...
    $formRouteCreate = 'task-user.create';
    $formRouteStore = 'task-user.store';
    $formRouteEdit = 'task-user.edit';

    //collaboration
    $formRouteCollaborationIndex = 'user-collaboration.index';
?>
@endsection
...
<div class="flash-message mt-2">
    ...
    @if ($countData > 0 || $countDataTwo > 0)
        ...
        <div class="card mt-2">
                                    ...
                                    <div class="alert alert-{{ $statusCSS }}">
                                        ...
                                        <ul class='list-inline'>
                                            ...
                                            <li class='list-inline-item'>
                                                ...
                                                <?php /* {!! \Illuminate\Support\Str::limit(ucfirst($data->task_desc),33,'...') !!} */ ?>
                                            </li>
                                        </ul>
                                        <div>
                                            @if ($data->task_status != 3)
                                                <form action="{{ route('task-user.update', $data->task_id) }}" style="display:inline-block" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                    @csrf
                                                    @method('PUT')
            ...
            <div class="card-body">
                <div class="col-md"> 
                    <a href="{{ route($formRouteCreate) }}" class="btn btn-orange"><i class="fa fa-plus"></i> Tambah tugas</a>
                    <a href="{{ route($formRouteCollaborationIndex) }}" class="btn btn-orange"><i class="fa fa-eye"></i> Kolaborasi</a>
                </div>
            </div>
        </div> <!-- card -->
        @endif
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="alert alert-{{ $statusCSS }}">
                                        ...
                                        <ul class='list-inline'>
                                            ...
                                            <?php /* {!! \Illuminate\Support\Str::limit(ucfirst($data1->task_desc),33,'...') !!} */ ?>
                                        </ul>
                                        <div>
                                            @if ($data1->task_status != 3)
