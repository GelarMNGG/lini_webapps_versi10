...
<?php ### customized data
    ...
    $formRouteStore = 'task-user.store';
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md form-group">
                            ...
                            <input type="date" class="form-control{{ $errors->has('task_due_date') ? ' has-error' : '' }}" name="task_due_date" value="{{ old('task_due_date') ?? '' }}" min="{{ date('Y-m-d') }}" placeholder="dd/mm/yyyy">
...
<script>
    ...
    $('#receiver_type').on('change',function(){
        ...
        if(stateID){
            $.ajax({
            type:"GET",
            url:"{{url('user/get-user-list')}}?input_param="+stateID,
