            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card-box task-detail">
                        ...
                        <div class="row">
                            <div class="col">
                                <span class='badge badge-{{ $statusCSS }}'>{{ ucwords($taskData->pengiriman_status) }}</span>
                                
                                <a href="#" class="btn btn-warning float-right">Lihat</a>
                                
                                <h4 class="text-muted">Kategori tugas: <span class='text-dark'>[ Internal ]</span></h4>

                                <h4 class="text-muted">Nama proyek: <span class='text-dark'>{{ ucfirst($projectName) }}</span></h4>
                            </div>
                        </div>
                        <hr>
                                ...
                                @if ($taskData->task_status != 3)
                                    @if($taskData->task_receiver_id == $userId && $taskData->receiver_type == $userType)
                                        <form action="{{ route($formRouteUpdate, $taskData->task_id) }}" style="display:inline-block" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                            ...
                                            <input class="form-control" type="text" name="nama_barang" value="{{ ucfirst($taskData->task_title) }}" hidden>
                                            <input class="form-control" type="number" name="receiver_id" value="{{ $taskData->task_publisher_id }}" hidden>
                                            <input class="form-control" type="text" name="receiver_type" value="{{ $taskData->publisher_type }}" hidden>
                                    ...
                                    @else
                                        <button class='btn btn-icon waves-effect waves-light btn-info t-white'> <i class='fas fa-hourglass-half' title='done'> </i> On progress</button>
                                    @endif
                        ...
                        <ul class="list-group mb-0 user-list">
                            @if($countData > 0)
                                ...
                                <li class='list-group-item'>
                                    <a href="{{ route($formRouteEdit, $data2->task_id) }}" class='user-list-item'>
