                ...
                <div class="col-12">
                    <form action="{{ route($formRouteStore) }}" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md form-group{{ $errors->has('number') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route($formRouteIndex,'project_id='.$infoTaskProject->project_id.'&task_id='.$infoTaskProject->id) }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
