...
<?php ### customized data
    ...
    $formRouteStore = 'user-clockin.update';
?>
@endsection
...
<div class="card mt-2">
    ...
    <div class="card-body">
        ...
        <form class="w-100" action="{{ route($formRouteStore, $clockinData->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method ('PUT')
            <div class="row m-0" style="display:inline">
                <div class="col-md form-group">
                    ...
                    <div class="input-group">
                        <input id="timepicker3" name="clockin" type="text" class="form-control" value="{{ old('clockin') ? old('clockin') : date('H:i A', strtotime($clockinData->clockin)) }}" required>
