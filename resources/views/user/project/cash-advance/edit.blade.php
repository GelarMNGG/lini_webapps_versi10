                        ...
                        <div class="row m-0">
                            ...
                            <div class="col-md-6">
                                <div class="{{ $errors->has('image') ? ' has-error' : '' }}">
                                    ...
                                    @if($dataCashAdvance->image != null)
                                        <input type="file" name="image" class="dropify" data-max-file-size="2M" data-default-file="{{ asset('img/cash-advance/tech/'.$dataCashAdvance->image) }}"  />
                                    @else
