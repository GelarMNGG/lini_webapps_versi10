                                ...
                                @foreach ($projectTaskDatas as $data)
                                    <div class="col-md-4 p-2">
                                        <div class="bg-card-box br-5 p-2">
                                            ...
                                            <br>
                                            @if($data->date_start)
                                                Mulai: <span class="text-success">{{ date('l d F Y', strtotime($data->date_start)) }}</span><br>
                                            @endif

                                            @if($data->date_end)
                                                Selesai: <span class="text-info">{{ date('l d F Y', strtotime($data->date_end)) }}</span>
                                            @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <div class="form-group">
                                <label for=""></label>
                                <input type="submit" class="btn btn-orange" name="submit" value="Tambah task">
                            </div>
                        </div>
                    </div>
                </form>
