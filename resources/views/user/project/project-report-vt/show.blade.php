            ...
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <ol>
                                            @if(isset($projectReportFormatTitles))
                                                @foreach($projectReportFormatTitles as $tocTitle)
                                                    <h4> <li> {{ ucfirst($tocTitle->title) }}
                                                        <form action="{{ route($formReportFormatTitleDestroy, $tocTitle->id) }}" method="POST" class="d-print-none" style="display:inline;">
                                                            ...
                                                            <!-- report type -->
                                                                @if($tocTitle->title_count > 0)
                                                                    <button type="button" class="border-dashed text-warning small" data-toggle="modal" data-target="#editliniModal{{ $tocTitle->id }}" title="Edit Report type"> <i class="fa fa-cogs"></i></button>
                                                                @else
                                                                    <button type="button" class="border-dashed text-dark small" data-toggle="modal" data-target="#liniModal{{ $tocTitle->id }}" title="Add Report type"> <i class="fa fa-cogs"></i></button>
                                                                @endif
                                                            <!-- data sources -->
                                                                @if($tocTitle->type)
                                                                    <button type="button" class="border-dashed text-warning small" data-toggle="modal" data-target="#dataModal{{ $tocTitle->id }}" title="Database"> <i class="fa fa-database"></i></button>
                                                                @endif
                                                            <!-- add subtitle -->
                                                    ...
                                                    <!-- add report type modal -->
                                                        <div class="modal fade" id="liniModal{{ $tocTitle->id }}" tabindex="-1" role="dialog" aria-labelledby="liniModal{{ $tocTitle->id }}Label" aria-hidden="true">
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content" style="max-height:unset;">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Tambah Format laporan</h5>
                                                    ...
                                                    <!-- add report type modal end -->
                                                    <!-- edit modal -->
                                                    @if($tocTitle->title_count > 0)
                                                        <div class="modal fade" id="editliniModal{{ $tocTitle->id }}" tabindex="-1" role="dialog" aria-labelledby="editliniModal{{ $tocTitle->id }}Label" aria-hidden="true" >
                                                            <form action="{{ route($formReportFormatUpdate,$tocTitle->praf_id) }}" style="display:inline-block;" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                                @csrf
                                                                @method('PUT')
                                                                <!-- hidden value -->
                                                                    <input type="hidden" name="project_id" value="{{ $projectTask->project_id }}">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6 text-left">
                                                                                    ...
                                                                                    @if(isset($projectReportFormatCodeDatas))
                                                                                        @foreach($projectReportFormatCodeDatas as $projectReportFormatCodeData)
                                                                                        <?php
                                                                                            if ($projectReportFormatCodeData->id == $tocTitle->f_code) {
                                                                                                $check = ' checked';
                                                                                            }else{$check = '';}
                                                                                            //disable mix format
                                                                                            if ($projectReportFormatCodeData->text_count > 0 && $projectReportFormatCodeData->image_count > 0) {
                                                    ...
                                                    <!-- edit modal end -->
                                                    <!-- data modal -->
                                                    @if(isset($tocTitle->praf_id))
                                                        <!-- template modal -->
                                                            <div class="modal fade" id="dataModal{{ $tocTitle->id }}" tabindex="-1" role="dialog" aria-labelledby="dataModal{{ $tocTitle->id }}Label" aria-hidden="true">
                                                                <form action="{{ route($formReportFormatUpdate,$tocTitle->praf_id) }}" style="display:inline-block; width:100%;" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <!-- hidden value -->
                                                                        <input type="hidden" name="project_id" value="{{ $projectTask->project_id }}">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content" style="max-height:unset;">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Pilih template data</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-md form-group">
                                                                                                ...
                                                                                                <select id="template_id" name="template_id" class="form-control select2{{ $errors->has('template_id') ? ' has-error' : '' }}" required>
                                                                                                    <?php
                                                                                                        ...
                                                                                                        }elseif(isset($tocTitle->template_id)){
                                                                                                            $template_id = $tocTitle->template_id;
                                                                                                        }else{
                                                                                                            $template_id = null;
                                                                                                        }
                                                                                                    ?>
                                                                                                    ...
                                                                                                    @endif
                                                                                                    @foreach($projectReportTemplateSelectedDatas as $dataTemplate)
                                                                                                        @if ($dataTemplate->type == $tocTitle->type)
                                                                                                                <option value='{{ $dataTemplate->template_id }}'>{{ strtoupper(strtolower($dataTemplate->name)) }}</option>
                                                                                                            @endif
                                                                                                    @endforeach
                                                                                                </select>
                                                                ...
                                                                @foreach($projectReportFormatSubTitles as $tocSubTitle)
                                                                    @if($tocSubTitle->title_id == $tocTitle->id)
                                                                        <li>
                                                                            ...
                                                                            <form action="{{ route($formReportFormatSubTitleDestroy, $tocSubTitle->id) }}" method="POST" class="d-print-none" style="display:inline; width:100%;">
                                                                                @method('DELETE')
                                                                                @csrf
                                                                                <!-- hidden data -->
                                                                                    <input type="hidden" name="project_id" value="{{ $projectTask->project_id }}">
                                                                                ...
                                                                                <!-- report type -->
                                                                                    @if($tocSubTitle->subtitle_count > 0)
                                                                                        <button type="button" class="border-dashed text-warning small" data-toggle="modal" data-target="#editlinisubtitleModal{{ $tocSubTitle->id }}" title="Edit Report type"> <i class="fa fa-cogs"></i></button>
                                                                                    @else
                                                                                        <button type="button" class="border-dashed text-dark small" data-toggle="modal" data-target="#linisubtitleModal{{ $tocSubTitle->id }}" title="Add Report type"> <i class="fa fa-cogs"></i></button>
                                                                                    @endif
                                                                                <!-- data sources -->
                                                                                    @if($tocSubTitle->type)
                                                                                        <button type="button" class="border-dashed text-warning small" data-toggle="modal" data-target="#datasubtitleModal{{ $tocSubTitle->id }}" title="Database"> <i class="fa fa-database"></i></button>
                                                                                    @endif
                                                                                <!-- edit -->
                                                                        ...
                                                                        <!-- add report type modal subtitle -->
                                                                            <div class="modal fade" id="linisubtitleModal{{ $tocSubTitle->id }}" tabindex="-1" role="dialog" aria-labelledby="linisubtitleModal{{ $tocSubTitle->id }}Label" aria-hidden="true">
                                                                                <form action="{{ route($formReportFormatStore) }}" style="display:inline-block; width:100%;" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                                                    @csrf
                                                                                    <!-- hidden value -->
                                                                                        <input type="hidden" name="project_id" value="{{ $projectTask->project_id }}">
                                                                                        ...
                                                                                        <input type="hidden" name="pra_id" value="{{ $projectReportAllData->id }}">
                                                                                        <input type="hidden" name="sort_order" value="1">
                                                                                        <input type="hidden" name="subtitle_id" value="{{ $tocSubTitle->id }}">
                                                                                    <!-- hidden value end -->
                                                                                    <div class="modal-dialog" role="document">
                                                                                        <div class="modal-content" style="max-height:unset;">
                                                                                            <div class="modal-header">
                                                                        ...
                                                                        <!-- add report type modal end subtitle -->
                                                                        <!-- edit modal subtitle -->
                                                                        @if($tocSubTitle->subtitle_count > 0)
                                                                            <div class="modal fade" id="editlinisubtitleModal{{ $tocSubTitle->id }}" tabindex="-1" role="dialog" aria-labelledby="editlinisubtitleModal{{ $tocSubTitle->id }}Label" aria-hidden="true" >
                                                                                <form action="{{ route($formReportFormatUpdate,$tocSubTitle->praf_id) }}" style="display:inline-block;" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                                                    @csrf
                                                                                    @method('PUT')
                                                                                    <!-- hidden value -->
                                                                                        <input type="hidden" name="project_id" value="{{ $projectTask->project_id }}">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col-md-6 text-left">
                                                                                                        ...
                                                                                                        @if(isset($projectReportFormatCodeDatas))
                                                                                                            @foreach($projectReportFormatCodeDatas as $projectReportFormatCodeData)
                                                                                                            <?php
                                                                                                                if ($projectReportFormatCodeData->id == $tocSubTitle->f_code) {
                                                                                                                    $check = ' checked';
                                                                                                                }else{$check = '';}
                                                                                                                //disable mix format
                                                                                                                if ($projectReportFormatCodeData->text_count > 0 && $projectReportFormatCodeData->image_count > 0) {
                                                                                                                ...
                                                                                                                <div class="form-check col-md">
                                                                                                                    ...
                                                                                                                    <label class="form-check-label" for="f_code{{ $icode }}">
                                                                                                                        ...
                                                                                                                        @else
                                                                                                                            ...
                                                                                                                            {{ $projectReportFormatCodeData->image_count != 0 ? ' '.$projectReportFormatCodeData->image_count.' gambar' : '' }}
                                                                                                                            <!-- file -->
                                                                                                                            {{ $projectReportFormatCodeData->file_count != 0 ? ' Format file' : '' }}
                                                                                                                        @endif
                                                                                                                    </label>
                                                                                                                    <br>
                                                                                                                    <img src="{{ asset('img/projects/report/report_format/'.$projectReportFormatCodeData->image) }}" class="img-responsive">
                                                                        ...
                                                                        @endif
                                                                        <!-- edit modal end subtitle -->
                                                                        <!-- data modal subtitle -->
                                                                        @if(isset($tocSubTitle->praf_id))
                                                                            <div class="modal fade" id="datasubtitleModal{{ $tocSubTitle->id }}" tabindex="-1" role="dialog" aria-labelledby="datasubtitleModal{{ $tocSubTitle->id }}Label" aria-hidden="true">
                                                                                <form action="{{ route($formReportFormatUpdate,$tocSubTitle->praf_id) }}" style="display:inline-block; width:100%;" method="post" enctype="multipart/form-data" data-parsley-validate novalidate>
                                                                                    @csrf
                                                                                    @method('PUT')
                                                                                    <!-- hidden value -->
                                                                                        <input type="hidden" name="project_id" value="{{ $projectTask->project_id }}">
                                                                                                            ...
                                                                                                            <div class="col-md form-group">
                                                                                                                ...
                                                                                                                <select id="template_id" name="template_id" class="form-control select2{{ $errors->has('template_id') ? ' has-error' : '' }}" required>
                                                                                                                    <?php
                                                                                                                        if(old('template_id') != null) {
                                                                                                                            $template_id = old('template_id');
                                                                                                                        }elseif(isset($tocSubTitle->template_id)){
                                                                                                                            $template_id = $tocSubTitle->template_id;
                                                                                                                        }else{
                                                                                                                            $template_id = null;
                                                                                                                        }
                                                                                                                    ?>
                                                                                                                    ...
                                                                                                                    @endif
                                                                                                                    @foreach($projectReportTemplateSelectedDatas as $dataTemplate)
                                                                                                                        @if ($dataTemplate->type == $tocSubTitle->type)
                                                                                                                                <option value='{{ $dataTemplate->template_id }}'>{{ strtoupper(strtolower($dataTemplate->name)) }}</option>
                                                                                                                            @endif
                                                                                                                    @endforeach
                                                                                                                </select>
                                                ...
                                                <hr>
                                            @endif
                                            <div class="small text-danger d-print-none">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    @if(isset($projectReportFormatTitles))
                                        <ol>
                                            @foreach($projectReportFormatTitles as $tocTitle)
                                                <h4> <li> {{ ucfirst($tocTitle->title) }} </li> </h4>
                                                <div class="row">
                                                    @if(isset($tocTitle->template_id))
                                                        @if(isset($projectReportTemplateContentDatas))
                                                            <!-- tipe -->
                                                            <?php $image = 1; $text = 2; $files = 6; ?>
                                                            @if($tocTitle->type == $image)
                                                                <?php $iContent = 1; ?>
                                                                @foreach($projectReportTemplateContentDatas as $templateContent)
                                                                    @if($templateContent->template_id == $tocTitle->template_id)
                                                                        <?php 
                                                                            //column count
                                                                            $columnData = $tocTitle->image_count;
                                                                            if ($columnData == 3) {
                                                                                $column = 4;
                                                                                $columnDiv = 3;
                                                                            }elseif($columnData == 2){
                                                    ...
                                                    @else
                                                        <div class="col-md">
                                                            @if(isset($tocTitle->image))
                                                                <img src="{{ asset('img/projects/report/report_format/'.$tocTitle->image) }}" class="img-fluid">
                                                            @endif
                                                        </div>
                                                    @endif
                                                </div>
                                                    ...
                                                    @if($tocTitle->subtitleCount > 0)
                                                        <ul class="">
                                                            @foreach($projectReportFormatSubTitles as $tocSubTitle)
                                                                @if($tocSubTitle->title_id == $tocTitle->id)
                                                                    <li>
                                                                        <strong>{{ ucfirst($tocSubTitle->subtitle) }}</strong>
                                                                    </li>
                                                                    @if(isset($tocSubTitle->template_id))
                                                                        @if(isset($projectReportTemplateContentDatas))
                                                                            <!-- tipe -->
                                                                            <?php $image = 1; $text = 2; $files = 6; ?>
                                                                            @if($tocSubTitle->type == $image)
                                                                                <?php $iContent = 1; ?>
                                                                                @foreach($projectReportTemplateContentDatas as $templateContent)
                                                                                    @if($templateContent->template_id == $tocSubTitle->template_id)
                                                                                        <?php 
                                                                                            //column count
                                                                                            $columnData = $tocSubTitle->image_count;
                                                                                            if ($columnData == 3) {
                                                                                                $column = 4;
                                                                                                $columnDiv = 3;
                                                                                            }elseif($columnData == 2){
                                                                    ...
                                                                    @else
                                                                        <div class="col-md">
                                                                            @if(isset($tocSubTitle->image))
                                                                                <img src="{{ asset('img/projects/report/report_format/'.$tocSubTitle->image) }}" class="img-fluid">
                                                                            @endif
                                                                        </div>
                                                                    @endif
                                                                @endif
                    ...
                    <?php 
                        ...
                        $css_text_3 = 'dark'; 
                        $css_text_4 = 'dark'; 
                        $fa_code_1 = 'times text-danger'; 
                        $fa_code_2 = 'times text-danger'; 
                        $fa_code_3 = 'times text-danger'; 
                        $fa_code_4 = 'times text-danger'; 
                    ?>
