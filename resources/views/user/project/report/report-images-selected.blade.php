...
<?php ### customized data
    ...
    //back route
    $formProjectRouteIndex = 'user-projects.index';
    //image comments
    $formImageCommentsStore = 'user-projects-image-comments.store';
    //report comments
    $formReportCommentsStore = 'user-projects-report-comments.store';
    $formReportCommentsDestroy = 'user-projects-report-comments.destroy';
    //template
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <div class="panel-heading text-center text-uppercase">
                            ...
                            <br><small>Task:</small> <strong><span class="text-uppercase text-danger">{{ $project->task_name }}</span></strong>
                        </div>
                        <hr>
                        ...
                        <div class="col-md-12 panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <h4 class="text-uppercase">{{ $projectTemplate->category_name }}</h4>
                                </div>
                                <div class="w-100"></div>
                                <div class="col-md-12">
                                    <div class="row m-0">
                                                    ...
                                                    <div class="col-sm form-group text-center">
                                                        <label>
                                                            ...
                                                            <div class="img-report-box border-dashed border-rounded">
                                                                ...
                                                                @if($dataProjectPicture->shared > 0)
                                                                    <h5 class="text-warning h5-report">Terkirim ke pelanggan</h5>
                                                                @endif
                                                ...
                                                @foreach($dataProjectPicturesCustom as $dataProjectPicture2)
                                                    <div class="col-sm form-group">
                                                        <label>
                                                            ...
                                                            <div class="img-report-box border-dashed border-radius">
                                                                <img name="image" class="img-report img-thumbnail img-fluid" src="{{ asset('/img/projects/'.$dataProjectCategory->folder.'/'.$dataProjectPicture2->image) }}"  />
                                                            </div>
                                                        </label>
                            ...
                            <div class="row m-0 mb-5">
                                ...
                                <div class="col-md">
                                    <div class="clearfix">
                                        <h5 class="small text-dark text-uppercase mb-5">{{ isset($project->customer_name) ? ucwords($project->customer_name) : 'Belum ada' }}
                                        </h5>
                                        <hr class="mb-0">
                                        <small>
                            ...
                            <div class="d-print-none">
                                ...
                                <div class="float-right">
                                    ...
                                    <a href="{{ route($formTemplateIndex,'project_id='.$project->id.'&task_id='.$infoProjectTask->id) }}" type="button" class="btn btn-secondary">Kembali</a>
                                    ...
                                    @if(Auth::user()->user_level == 4)
                                        @if($dataProjectPicturesStatus->countApproved > 0)
                                            ...
                                            <!-- the data status -->
                                            <button type="submit" class="btn btn-icon waves-effect waves-light btn-warning" name="submit"><i class='fas fa-edit' title='done'> </i> Edit laporan gambar</button>
                                            @endif
                                        @else
                                            <input class="form-control" type="text" name="status" value="3" hidden>
                                            <button type="submit" class="btn btn-icon waves-effect waves-light btn-warning" name="submit"><i class='fas fa-paper-plane' title='done'> </i> Approve laporan gambar</button>
                                        @endif
                                    @endif
                                    */ ?>
