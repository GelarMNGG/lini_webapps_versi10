        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="card bg-gray-lini">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        <h4 class="text-uppercase mt-0">masuk | <span class="text-info">tech</span></h4>
                    </div>
                    ...
                    @endif
                    <form method="POST" enctype="multipart/form-data" action="{{ route('tech.login.submit') }}" data-parsley-validate novalidate>
                        @csrf
