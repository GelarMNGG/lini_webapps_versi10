        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="card bg-gray-lini">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        <h4 class="text-uppercase mt-0">Daftar | <span class="text-info">admin</span></h4>
                    </div>
                ...
                <div class="text-center">
                    <p class="text-muted">Sudah punya akun?  <a href="{{ route('admin.login') }}" class="text-dark ml-1"><b>Masuk</b></a></p>
                </div> <!-- end col -->
            </div>
            <!-- end card -->
            <!-- end row -->
