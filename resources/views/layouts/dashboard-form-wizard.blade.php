...
<html lang="en">
    ...
    <body>
        ...
        <!-- Plugins js-->
        <script src="{{ asset('admintheme/libs/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js') }}"></script>
        <!-- Init js-->
        <script src="{{ asset('admintheme/js/pages/form-wizard.init.js') }}"></script>
        <!-- App js -->
