...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        //tasks list
        $data['countDataTwo'] = DB::table('tasks')->where('task_publisher_id',$userId)->where('publisher_type',$userType)->count();
    ...
    public function store(Request $request)
    {
        ...
        $receiverId = $request->task_receiver_id;
        $receiverType = $request->receiver_type;
        if ($receiverType == 'admin') {
            $adminDatas = DB::table('admins')->select('department_id')->where('id',$receiverId)->first();
            $receiverDepartment = $adminDatas->department_id;
        }else{
            $userDatas = DB::table('users')->select('department_id')->where('id',$receiverId)->first();
            $receiverDepartment = $userDatas->department_id;
        }
        $request['receiver_department'] = $receiverDepartment;
        ...
        return redirect()->route('task.index')->with('alert-success','Penugasan berhasil disimpan.');
    }
    ...
    public function show($id)
    {
        ...
        $data['dataComments'] = DB::table('tasks_comments as tc')
            ->select([
                'tc.*',
                DB::raw('(SELECT COUNT(comment_id) FROM tasks_comments_files WHERE tasks_comments_files.comment_id = tc.tc_id) countFiles')
            ])
            ->where('tc_task_id', $id)
            ->orderBy('tc_id','DESC')
            ->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($request->status)) {
            ...
            return redirect()->route('task.index')->with('alert-success','Status tugas berhasil diperbarui.');
        }else{
            ...
            return redirect()->route('task.index')->with('alert-success','Data tugas berhasil diperbarui.');
        }
