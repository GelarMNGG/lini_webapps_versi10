...
namespace App\Http\Controllers\Admin\Satgas\Covid;
...
class AdminSatgasSliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.satgas.covid.slider.index', $data);
    }
    ...
    public function create()
    {
        ...
        if ($userDepartment == 5 || $userDepartment == 4 ) {
            ...
            $data['sliders'] = DB::table('sliders as sls')
                ...
                ->get();
            return view('admin.satgas.covid.slider.create', $data);
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-covid-slider.index')->with('success','Data berhasil disimpan.');
    }
    ...
    {
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Satgas Covid Slider.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.satgas.covid.slider.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin-covid-slider.index')->with('success','Data berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin-covid-slider.index')->with('success', 'Data berhasil dihapus.');
    }
}
