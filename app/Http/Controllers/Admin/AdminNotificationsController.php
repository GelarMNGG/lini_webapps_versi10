...
class AdminNotificationsController extends Controller
{
    ...
    public function update(Request $request, $notifikasi)
    {
        ...
        if (isset($request->all)) {
            ...
            return redirect()->route('notifikasi-admin.index')->with('alert-success','Status notifikasi berhasil diperbarui.');
        }
        ...
        return redirect()->route('notifikasi-admin.index')->with('success','Data notifikasi berhasil diperbarui.');
    }
