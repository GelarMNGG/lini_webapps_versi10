...
class ProcCompetencyTest extends Controller
{
    ...
    public function index()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-test-competency.index',$data);
        }
    ...
    public function create()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-test-competency.create',$data);
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Tes Kompetensi.');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return redirect()->route('admin-proc-test-competency.index')->with('alert-success','Data berhasil disimpan');
        }                     
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Tes Kompetensi.');
    }
    ...
    public function edit($id)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-test-competency.edit',$data);
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Tes Kompetensi.');
    }
    ...
    public function destroy($id)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
               ...
               return redirect()->route('admin-proc-test-competency.index')->with('alert-success','Data berhasil dihapus.');
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Tes Kompetensi.');
    }
}
