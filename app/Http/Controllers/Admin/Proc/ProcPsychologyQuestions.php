...
class ProcPsychologyQuestions extends Controller
{
    ...
    public function index()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-test-psychology.index',$data);
        }
    ...
    public function create()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-test-psychology.create',$data);
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Tes Psikologi.');
    }
    ...
    public function edit($id)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-test-psychology.edit',$data);
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Tes Psikologi.');
    }
