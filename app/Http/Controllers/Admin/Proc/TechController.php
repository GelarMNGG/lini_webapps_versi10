...
class TechController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            if ($skin == 1) {
                ...
                return view('admin.tech.index-table', $data);
            }else{
                $data['skin'] = 1;
                $data['skinBack'] = 0;
    ...
    public function create()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.tech.create', $data);
        }
    ...
    public function store(Request $request)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return redirect()->route('admin-tech.index')->with('alert-success','Data berhasil disimpan.');
        }
    ...
    public function show($id)
    {
        ...
        if ($userCompany == 1 && $userDepartment == 9 || $userRole == 1) {
            ...
            return view('admin.tech.show', $data);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($userCompany == 1 && $userDepartment == 9 || $userRole == 1) {
            $request->validate([
                ...
                'address' => 'required|min:10',
                'image' => 'mimes:jpeg,jpg,png,pdf|max:2048',
                'email' => 'required|email|string|max:255|unique:techs,email,'.$id,
            ...
            return redirect()->route('admin-tech.index')->with('alert-success','Data berhasil diubah.');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($userCompany == 1 && $userDepartment == 9 || $userRole == 1) {
            ...
            return redirect()->route('admin-tech.index')->with('alert-success','Data berhasil dihapus.');
        }
