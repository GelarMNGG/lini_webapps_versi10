...
class ProcAssesmentQuestionsCategories extends Controller
{
    ...
    public function index()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-assesment-question-category.index',$data);
        }
    ...
    public function create()
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            return view('admin.proc.proc-assesment-question-category.create');
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Kategori.');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return redirect()->route('admin-assesment-question-cat.index')->with('alert-success','Data berhasil disimpan');
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Kategori.');
    }
    ...
    public function edit($id)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            ...
            return view('admin.proc.proc-assesment-question-category.edit',$data);
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Kategori.');
    }
    ...
    public function destroy($id)
    {
        ...
        if($userCompany == 1 && $userDepartment == 9 || $userRole == 1){
            if ($dataCheck > 0) {
                ...
                return redirect()->route('admin-assesment-question-cat.index')->with('alert-success', 'Data berhasil dihapus.');
            }
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Kategori.');
    }
