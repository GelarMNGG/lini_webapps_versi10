...
class TechBugReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tech.bug-report.index',$data);
    }
    ...
    {
        return view('tech.bug-report.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        //file handler
        $fileName = null;
        $destinationPath = public_path().'/img/bug-report/tech/';
        ...
        return redirect()->route('tech-bug-report.index')->with('alert-success','Data berhasil disimpan');
    }
    ...
    public function edit($id)
    {
        ...
        if (isset($firstcheck)) {
            ...
            return view('tech.bug-report.edit',$data);
        }
    ...
    public function destroy($id)
    {
        ...
        if ($userDepartment == 5 && $firstcheck > 0) {
            ...
            return redirect()->route('tech-bug-report.index')->with('alert-success','Data berhasil dihapus.');
        }
