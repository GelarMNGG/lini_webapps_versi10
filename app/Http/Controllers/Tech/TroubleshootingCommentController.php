                ...
                foreach ($commentorDatas as $dataAlpha) {
                    if ($dataAlpha->publisher_id != $userId && $dataAlpha->publisher_type != $userType) {
                        ...
                        if ($receiverType == 'admin') {
                            ...
                            $dataNotif['desc'] = "<strong>".$publisherName."</strong> memberikan komentar pada task <a href='".route('user.troubleshootingdetail',$theId)."'><strong>".ucfirst($theTitle)."</strong></a> untuk Anda.</strong>";
                        }else{
                            $dataNotif['desc'] = "<strong>".$publisherName."</strong> memberikan komentar pada task <a href='".route('tech.troubleshootingdetail',$theId)."'><strong>".ucfirst($theTitle)."</strong></a> untuk Anda.</strong>";
                        }
