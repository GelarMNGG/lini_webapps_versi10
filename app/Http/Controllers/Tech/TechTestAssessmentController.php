...
class TechTestAssessmentController extends Controller
{
    ...
    {
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman Assessment Test.');
    }
    ...
    public function store(Request $request)
    {
        ...
        $firstCheck = DB::table('proc_test_assessment_results')->where('tech_id',$userId)->count();
        ...
        return redirect()->back()->with('alert-danger','Anda telah mengisi dan menyelsaikan tes assessment.');
    }
