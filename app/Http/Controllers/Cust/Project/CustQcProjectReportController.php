...
class CustQcProjectReportController extends Controller
{
    ...
    public function show($id)
    {
        ...
        //check priviledge
            $custCheck = DB::table('projects')->where('id',$projectId)->where('customer_id',$userId)->where('deleted_at',null)->count();
            if ($custCheck < 1) {
        ...
        if (isset($privilegeCheck)) {
            ...
            ### comments ###
                ...
                //data user
                    ...
                    ->get();
            ### comments end ###
            return view('cust.project.report-qc.show',$data);
        }
        return redirect()->back()->with('alert-danger','Anda tidak diijinkan mengakses halaman report project.');
    }
