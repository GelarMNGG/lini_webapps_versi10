...
namespace App\Http\Controllers\User\Satgas\Covid;
...
class UserSatgasSliderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.satgas.covid.slider.index', $data);
    }
    ...
    public function create()
    {
        ...
        if ($userDepartment == 5 || $userDepartment == 4 ) {
            ...
            $data['sliders'] = DB::table('sliders as sls')
                ...
                ->get();
            return view('user.satgas.covid.slider.create', $data);
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user-covid-slider.index')->with('success','Data berhasil disimpan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.satgas.covid.slider.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user-covid-slider.index')->with('success','Data berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user-covid-slider.index')->with('success', 'Data berhasil dihapus.');
    }
}
