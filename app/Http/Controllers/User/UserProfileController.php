...
class UserProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['userProfile'] = User::find($userId);
    ...
    public function update(Request $request, $id)
    {
        $errorMessage = [
            ...
            #'company.required' => 'Field ini tidak boleh kosong.',
        ...
        return redirect()->route('profil-user.index')->with('success','Data profile berhasil diperbarui.');
    }
