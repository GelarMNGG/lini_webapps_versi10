...
class TaskInternalTodoCommentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //sent notifications
            ...
            ###notif message
            $dataNotif['desc'] = "<strong>".$publisherName."</strong> memberikan komentar pada cheklist <a href='".route('task-internal-todo.show',$theId.'?tid='.$theTaskId.'&did='.$theDeptId)."'><strong>".ucfirst($theTitle)."</strong></a>.";
