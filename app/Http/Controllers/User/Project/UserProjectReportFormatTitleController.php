...
class UserProjectReportFormatTitleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($privilegeCheck)) {
            ...
            DB::table('project_report_all_format_title')->insert($data);
            //redirect back
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($privilegeCheck)) {
            ...
            DB::table('project_report_all_format_title')->where('id',$id)->update($data);

            return redirect()->back()->with('alert-success','Data judul berhasil diubah.');
        }
        return redirect()->back()->with('alert-danger','Terjadi kesalahan jaringan, silahkan mencoba beberapa saat lagi.');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if (isset($privilegeCheck)) {
            //delete title
                DB::table('project_report_all_format_title')->delete($id);
            //delete sub title
                $subtitleDatas = DB::table('project_report_all_format_subtitle')->select('id')->where('title_id',$id)->get();
                if (isset($subtitleDatas)) {
                    foreach ($subtitleDatas as $subtitleData) {
                        DB::table('project_report_all_format_subtitle')->delete($subtitleData->id);
                    }
                }
            //delete report
                $dataReport = DB::table('project_report_all_format')->select('id')->where('title_id',$id)->first();
